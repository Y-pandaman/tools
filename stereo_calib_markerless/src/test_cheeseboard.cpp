...
int stereo_demo() {
  ...
  std::string frame_id = "1403709029787836928";
  std::string left_image_path = BASE + "/cam0/data/" + frame_id + ".png";
  std::string right_image_path = BASE + "/cam1/data/" + frame_id + ".png";
  ...
  LoadExtrinsics("/home/bdca/dataset/calibration/cam_checkerboard/"
                 "extrinsics_add_noise_no_cheeseboard_avg.yaml",
                 right_T_left);

#elif false
  const std::string BASE = "/home/bdca/dataset/V1_01_easy/mav0";
  std::string frame_id = "1403715398712143104";
  std::string left_image_path = BASE + "/cam0/data/" + frame_id + ".png";
  std::string right_image_path = BASE + "/cam1/data/" + frame_id + ".png";
  ...
  Matrix4d right_T_left;
  LoadExtrinsics("/home/bdca/dataset/calibration/cam_checkerboard/"
                 "extrinsics_add_noise_cheeseboard.yaml",
                 right_T_left);
  ...
  const std::string BASE =
      "/home/bdca/dataset/calibration/cam_checkerboard/mav0";
  std::string frame_id = "1403709031537837056";
  std::string left_image_path = BASE + "/cam0/data/" + frame_id + ".png";
  std::string right_image_path = BASE + "/cam1/data/" + frame_id + ".png";
  ...
  Matrix4d right_T_left;
  LoadExtrinsics("/home/bdca/dataset/calibration/cam_checkerboard/"
                 "extrinsics_add_noise2.0_1_no_cheeseboard1_20_multi.yaml",
                 right_T_left);
