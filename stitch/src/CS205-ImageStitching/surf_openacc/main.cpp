...
int mainStream(int single_mem_cpy, int blend_mode, int resolution_mode)
{
    ...
    while(1) 
    {
        ...
        try{
            ...
            IplImage* display = cvCloneImage(&(cvIplImage(stitched)));
            img_lock.unlock();
                      ...
                      const char* src1, const char* src2)
{
    ...
    {   
        ...
        try{
            ...
            img_lock.lock();
            // IplImage* display = cvCloneImage(&(IplImage)(*stitched_cpy));
            IplImage* display = cvCloneImage(&(cvIplImage(*stitched_cpy)));
            img_lock.unlock();
...
int main(int argc, char* argv[]) 
{
    ...
    switch (mode)
    {
        ...
        case 1 : // run static image match between a pair of images
            if (src1 == "") src1 = "../images/00001.jpg"; // if not provided, use sample image
            if (src2 == "") src2 = "../images/00002.jpg"; // if not provided, use sample image
