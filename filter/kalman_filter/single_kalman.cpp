 ...
 * @return {SingleKalmanFilter}
 */

SingleKalmanFilter::SingleKalmanFilter(double R = 1, double Q = 1, double A = 1,
 ...
 */
double SingleKalmanFilter::filter(double newSignal, double u = 0) {
  ...
  if (estimatedSignal == NULL) {
    ...
    // Kalman gain
    const double K = predCov * measurementVector *
                     (1 / ((measurementVector * predCov * measurementVector) +
                           measurementNoise));
 ...
 * @return {Number}
 */
double SingleKalmanFilter::lastMeasurement() { return estimatedSignal; }

/**
 * Set measurement noise Q
 * @param {double} noise
 */
void SingleKalmanFilter::setMeasurementNoise(double noise) {
 ...
 * @param {double} noise
 */
void SingleKalmanFilter::setProcessNoise(double noise) { processNoise = noise; }

/**
 * Get measurement noise Q
 * @return {double} noise
 */
double SingleKalmanFilter::getMeasurementNoise(void) {
 ...
 * @return {double} noise
 */
double SingleKalmanFilter::getProcessNoise(void) { return processNoise; }
