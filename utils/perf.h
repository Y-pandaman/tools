...
#define ZETTON_PERF_FUNCTION()                        \
  dvis_cpp::util::TimeCounterWrapper _timer_wrapper_( \
      dvis_cpp::util::get_full_name(__PRETTY_FUNCTION__))

#define ZETTON_PERF_FUNCTION_WITH_INDICATOR(indicator) \
  dvis_cpp::util::TimeCounterWrapper _timer_wrapper_(  \
      dvis_cpp::util::get_full_name(__PRETTY_FUNCTION__, indicator))

#define ZETTON_PERF_BLOCK_START()      \
  dvis_cpp::util::TimeCounter _timer_; \
  _timer_.Start()
