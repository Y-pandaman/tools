...
int stereo_demo() {
...
#elif false
  const std::string BASE = "/home/bdca/dataset/TUM/test/";
  ...
  camodocal::CameraPtr left_camera =
      camodocal::CameraFactory::instance()->generateCameraFromYamlFile(
          "/home/bdca/dataset/TUM/omni-radtan-1024/camera_left.yaml");
  camodocal::CameraPtr right_camera =
      camodocal::CameraFactory::instance()->generateCameraFromYamlFile(
          "/home/bdca/dataset/TUM/omni-radtan-1024/camera_right.yaml");

  // Extrinsics
  Matrix4d right_T_left;
  LoadExtrinsics("/home/bdca/dataset/TUM/omni-radtan-1024/extrinsics1.yaml",
                 right_T_left);
...
#elif false
  const std::string BASE =
      "/home/bdca/dataset/calibration/cam_checkerboard/cheeseboard";
  ...
  PoseManipUtils::rawyprt_to_eigenmat(Vector3d(g_noise_r, g_noise_r, g_noise_r),
                                      Vector3d(g_noise_t, g_noise_t, g_noise_t), delta);
  ...
  for (size_t i = 1; i <= g_picture_num; i++) {
    boost::format fmt("/home/bdca/dataset/TUM/test/%s/%d.%s");
